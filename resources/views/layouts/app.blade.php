...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Devstagran - @yield('titulo')</title>
          <!--script src="{{asset('js/app.js')}}" defer="stylesheet"></!--script-->
    ...
    @livewireStyles()
        ...
        <body  class="bg-gray-100"> 
            <header class="p-5 border-b bg-white shadow">
                ...
                <a href="{{route('home')}}" class="text-3xl font-black"> Devstagran</a>
 ...
 Crear
            ...
            @yield('contenido')
                ...
                <footer class="mt-10 text-center p-5 text-gray-500 font-bold uppercase">
                     DevStagran- todos los derechos reservados {{now()->year}}
                </footer>
